...
type NodeGroupTemplateNodeInfoResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	NodeInfo      []byte                 `protobuf:"bytes,1,opt,name=nodeInfo,proto3" json:"nodeInfo,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *NodeGroupTemplateNodeInfoResponse) GetNodeInfo() []byte {
	if x != nil {
		return x.NodeInfo
	}
	return nil
...
const file_externalgrpc_proto_rawDesc = "" +
	"\n" +
	"\x12externalgrpc.proto\x12/clusterautoscaler.cloudprovider.v1.externalgrpc\x1a\x19google/protobuf/any.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"e\n" +
	"\tNodeGroup\x12\x0e\n" +
	...
	"\x02id\x18\x01 \x01(\tR\x02id\"?\n" +
	"!NodeGroupTemplateNodeInfoResponse\x12\x1a\n" +
	"\bnodeInfo\x18\x01 \x01(\fR\bnodeInfo\"\xac\x04\n" +
	...
	"\x13NodeGroupGetOptions\x12S.clusterautoscaler.cloudprovider.v1.externalgrpc.NodeGroupAutoscalingOptionsRequest\x1aT.clusterautoscaler.cloudprovider.v1.externalgrpc.NodeGroupAutoscalingOptionsResponse\"\x00B0Z.github.com/samcday/binarylane-controller/protob\x06proto3"
